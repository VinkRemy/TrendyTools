...
// ========== TOOLS DATASET ==========
const toolsData = [
    { name: "Trianglelator", icon: "fa-ruler-combined", desc: "Triangle Calculator", category: "calculator" },
    { name: "GeoMarker", icon: "fa-map", desc: "Map Maker", category: "utilities" },
    { name: "MagicRebus", icon: "fa-laugh-beam", desc: "Rebus Generator", category: "text" },
    { name: "QR Forge", icon: "fa-qrcode", desc: "QR code generator", category: "utilities" },
    { name: "BetterText", icon: "fa-font", desc: "Smart Text Editor", category: "text" },
...
function renderTools(filter = '') {
    ...
    toolsData.forEach(tool => {
        ...
        // Maak de toolnaam in kleine letters voor de URL
        const toolUrl = tool.name.toLowerCase().replace(/\s+/g, '');
        html += `
            <div class="tool-card" style="--index: ${index}" onclick="location.href='/${toolUrl}';" title="Open ${tool.name}">
